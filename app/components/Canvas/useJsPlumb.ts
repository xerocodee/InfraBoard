...
export const useJsPlumb = (
  ...
  //   jsPlumbInstance.bind(EVENT_ELEMENT_CLICK, function (
  //     element: Element,
  //     event: PointerEvent
  //   ) {
  ...
  //   jsPlumbInstance.bind(INTERCEPT_BEFORE_DROP, function (
  //     params: BeforeDropParams
  //   ) {
  //     return onbeforeDropIntercept(jsPlumbInstance, params);
  //   });

  //   jsPlumbInstance.bind(EVENT_CONNECTION_DETACHED, function (
  ...
  //   jsPlumbInstance.bind(EVENT_CONNECTION, function (
